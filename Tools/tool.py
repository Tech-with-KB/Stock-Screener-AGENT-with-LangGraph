...
def simple_screener(screen_type:str, offset:int)-> str: 
    ...
    if screen_type not in yf.PREDEFINED_SCREENER_QUERIES:
        return f"Error: The requested screen type '{screen_type}' could not be found. Please choose from the available screeners: {list(yf.PREDEFINED_SCREENER_QUERIES.keys())}"
